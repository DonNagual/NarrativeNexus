...
#include "NarrativeNexus/Public/Widgets/Main/NN_Cpp_Widget_MainMenu.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNN_Cpp_Widget_MainMenu() {}

// Begin Cross Module References
NARRATIVENEXUS_API UClass* Z_Construct_UClass_UNN_Cpp_Widget_Main_NoRegister();
NARRATIVENEXUS_API UClass* Z_Construct_UClass_UNN_Cpp_Widget_MainMenu();
NARRATIVENEXUS_API UClass* Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_NoRegister();
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNN_Cpp_Widget_MainMenu_OnPlayButtonClicked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNN_Cpp_Widget_MainMenu, nullptr, "OnPlayButtonClicked", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNN_Cpp_Widget_MainMenu_OnPlayButtonClicked_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNN_Cpp_Widget_MainMenu_OnPlayButtonClicked_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UNN_Cpp_Widget_MainMenu_OnPlayButtonClicked()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNN_Cpp_Widget_MainMenu_OnPlayButtonClicked_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNN_Cpp_Widget_MainMenu::execOnPlayButtonClicked)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UNN_Cpp_Widget_MainMenu);
UClass* Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_NoRegister()
{
	return UNN_Cpp_Widget_MainMenu::StaticClass();
}
struct Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "Comment", "/**\n * \n */" },
#endif
		{ "IncludePath", "Widgets/Main/NN_Cpp_Widget_MainMenu.h" },
		{ "ModuleRelativePath", "Public/Widgets/Main/NN_Cpp_Widget_MainMenu.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MainWidget_MetaData[] = {
		...
		{ "ModuleRelativePath", "Public/Widgets/Main/NN_Cpp_Widget_MainMenu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Reference to the MainWidget" },
#endif
	};
#endif // WITH_METADATA
	...
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UNN_Cpp_Widget_MainMenu>::IsAbstract,
	};
...
UObject* (*const Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_UUserWidget,
	(UObject* (*)())Z_Construct_UPackage__Script_NarrativeNexus,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::ClassParams = {
	&UNN_Cpp_Widget_MainMenu::StaticClass,
	nullptr,
	&StaticCppClassTypeInfo,
	DependentSingletons,
	FuncInfo,
	Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	UE_ARRAY_COUNT(FuncInfo),
	UE_ARRAY_COUNT(Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::PropPointers),
	0,
	0x00B010A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::Class_MetaDataParams), Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_UNN_Cpp_Widget_MainMenu()
{
	if (!Z_Registration_Info_UClass_UNN_Cpp_Widget_MainMenu.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UNN_Cpp_Widget_MainMenu.OuterSingleton, Z_Construct_UClass_UNN_Cpp_Widget_MainMenu_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_UNN_Cpp_Widget_MainMenu.OuterSingleton;
}
template<> NARRATIVENEXUS_API UClass* StaticClass<UNN_Cpp_Widget_MainMenu>()
{
	return UNN_Cpp_Widget_MainMenu::StaticClass();
}
UNN_Cpp_Widget_MainMenu::UNN_Cpp_Widget_MainMenu(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
DEFINE_VTABLE_PTR_HELPER_CTOR(UNN_Cpp_Widget_MainMenu);
UNN_Cpp_Widget_MainMenu::~UNN_Cpp_Widget_MainMenu() {}
// End Class UNN_Cpp_Widget_MainMenu
