...
struct Z_CompiledInDeferFile_FID_NarrativeNexus_Source_NarrativeNexus_Public_Widgets_Main_NN_Cpp_Widget_MainGuide_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNN_Cpp_Widget_MainGuide, UNN_Cpp_Widget_MainGuide::StaticClass, TEXT("UNN_Cpp_Widget_MainGuide"), &Z_Registration_Info_UClass_UNN_Cpp_Widget_MainGuide, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNN_Cpp_Widget_MainGuide), 2769264948U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_NarrativeNexus_Source_NarrativeNexus_Public_Widgets_Main_NN_Cpp_Widget_MainGuide_h_1757611413(TEXT("/Script/NarrativeNexus"),
