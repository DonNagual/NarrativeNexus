...
void EmptyLinkFunctionForGeneratedCodeNarrativeNexus_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_NarrativeNexus()
	{
		if (!Z_Registration_Info_UPackage__Script_NarrativeNexus.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_NarrativeNexus_OnChatGPTResponseReceived__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_NarrativeNexus(Z_Construct_UPackage__Script_NarrativeNexus, TEXT("/Script/NarrativeNexus"), Z_Registration_Info_UPackage__Script_NarrativeNexus, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x29BCA696, 0xD9E4D431));
