...
UCLASS()
class NARRATIVENEXUS_API UNN_Cpp_GPT : public UObject, public INN_Cpp_IF_GPT
{
	GENERATED_BODY()

public:
	// Interface methods
	virtual FOnGPTResponseReceived& GetOnGPTResponseReceived() override;

	virtual void SendMessageToGPT(const FString& Message) override;
